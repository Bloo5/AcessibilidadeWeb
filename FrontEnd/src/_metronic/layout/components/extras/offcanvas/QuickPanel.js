        ...
        >
          ...
          <div className="offcanvas-content px-10">
            <div className="tab-content">
              ...
              >
                <div className="mb-15">
                  <p className="font-weight-bold mb-5">System Messages</p>
                ...
                <div className="mb-5">
                  <p className="font-weight-bold mb-5">Notifications</p>
              ...
              >
                <form className="form">
                  <div>
                    <p className="font-weight-bold mb-3">Customer Care</p>
                  ...
                  <div className="pt-2">
                    <p className="font-weight-bold mb-3">Reports</p>
                    <div className="form-group mb-0 row">
                      <label className="col-8 col-form-label">
                        Generate Reports:
                      </label>
                  ...
                  <div className="pt-2">
                    <p className="font-weight-bold mb-3">Memebers</p>
                    <div className="form-group mb-0 row">
                      <label className="col-8 col-form-label">
